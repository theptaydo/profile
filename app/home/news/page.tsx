      ...
      <section className="home-news">
        <div className="news-container">
          <div className="news-main-content">
            {/* Large Main News */}
            <div className="news-large-post left animations delay4">
            ...
            <div className="news-grid-posts">
              <div className="news-grid-post  bottom animations delay2">
              ...
              <div className="news-grid-post  bottom animations delay4">
          ...
          <div className="news-sidebar">
            ...
            <div className="news-small-post right animations delay2">
